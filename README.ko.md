...
[English](README.md) | **한국어** | [조작법](CONTROLS.md) | [스킬 목록](SKILLS.md) | [백서](WHITE_PAPER.ko.md)
...
- [x] **디아블로 1 보스 시스템**:
    ...
    - [x] 다른 유니크 보스들 (도살자, 레오릭 등)
    - [x] 보스 대사 시스템 ("Ah... Fresh Meat!")
    - [x] 보스별 유니크/마법 아이템 드랍 보장
...
- [x] **언어 선택 메뉴** - 시작 시 한글/영어 선택
    - ✅ **UI 및 시스템 메시지 완전 한글화**
    - ✅ **모든 게임 이벤트, 전투, 보스 및 함정 메시지 번역**
- [x] **플레이어 행동 쿨다운** - 입력 처리에서 쿨다운 강제
- [x] **밸런스 조정** - 실시간 게임플레이에 맞춰 난이도 조정
- [ ] **UI 개선**:
  - [x] 쿨다운 표시 (스킬 이름 옆 텍스트로 표시)
  - [ ] 실시간 HP/MP 바 애니메이션
  - [ ] 몬스터 행동 예측 표시

### 낮은 우선순위
- [x] **보스 특수 패턴** - 고유한 보스 행동 (완료)
